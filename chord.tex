...
\begin{Music}
  ...
  \en\Notes
  \figbassu[5][6]\wh{c}|\rw{3}\zw{'g}\wh{'e}%
  \en\Notes
  \figbassu[3][4][6]\wh{c}|\zw{'a}\rw{1}\wh{'e}%
  \en\Notes
...
\begin{floatMusic}[pos=ht,width=0.5\linewidth]
  ...
  \Startpiece%
  \NOTes%
  \zchordsu{C}\itied{0}{5}\zh{''e}\zh{''c}\zh{'g}\hl{'c}%
  \en%
  \NOTes%
  ...
  \generalsignature{-3}\setdoublebar\changecontext%
  \NOTes%
  \zchordsu{C\Min}\itied{0}{5}\zh{''e}\zh{''c}\zh{'g}\hl{'c}%
  \en%
  \NOTes%
