...
そのためこの和音は，第一にはドミナント・コード\Funktion{D}の代理として（\pieceref{Dの代理としての‌III‌m}），
第二にはトニック・コード\Funktion{T}の代理としての役割を果たすと言えるでしょう
（\pieceref{Tの代理としての‌III‌m}）．
...
変じられたLa\aFlat は調の上属音への下行導音として働くことがあります（\pieceref{Sの代理としての‌IV‌m}）．
...
（\pieceref{Tの代理としては‌bVI‌aug‌は働かない}）．
そのため，共通音の関係からは\Gniv\Min の持つサブドミナントの代理の性質を持つといえます
（\pieceref{Sの代理としての‌bVI‌aug}）．
...
\begin{floatMusic}[pos=ht]
  ...
  \piecelabel{Tの代理としては‌bVI‌aug‌は働かない}%
\end{floatMusic}
...
そのためこの和音は，第一にはトニック・コードの代理として（\pieceref{Tの代理としての‌VI‌m}），
第二にはサブドミナント・コードの代理としての役割を果たすと言えるでしょう（\pieceref{Sの代理としての‌VI‌m}）．
