...
\begin{Music}[0.9\linewidth]
  ...
  \Startpiece
  \Notes%
  \zchordsu{C}\zw{'g}\zw{'e}\wh{'c}%
  \zchordsu{C\Min}\zw{'g}\zw{'e}\wh{'c}%
  \zchordsu{C\Dimt}\zw{_'g}\fl[l]{'e}\zw{'e}\wh{'c}%
  \zchordsu{C\Aug}\zw{^'g}\zw{'e}\wh{'c}%
  \en\bar\Notes
  \lrchordsu{C&\subsc{\Maj7}}\zw{'b}\zw{'g}\zw{'e}\wh{'c}%
  \lrchordsu{C&\Min\subsc7}\zw{_'b}\zw{'g}\fl[ql]{'e}\zw{'e}\wh{'c}%
  \lrchordsu{C&\Min\subsc{\Maj7}}\zw{'b}\zw{'g}\zw{_'e}\wh{'c}%
  \en\Notes
  \zchordsu{C\subsc6}\rw{'a}\zw{'g}\zw{'e}\wh{'c}%
  \zchordsu{C\Min\subsc6}\rw{'a}\zw{'g}\zw{_'e}\wh{'c}%
  \zchordsu{C\subsc7}\zw{_'b}\zw{'g}\zw{'e}\wh{'c}%
  \zchordsu{C\hDim\subsc7}\zw{_'b}\fl[hl]{'g}\zw{'g}\fl[l]{'e}\zw{'e}\wh{'c}%
  \zchordsu{C\Dim\subsc7}\dfl{'b}\zw{'b}\fl[hll]{'g}\zw{'g}\fl[hl]{'e}\zw{'e}\wh{'c}%
  \en\bar\Notes
  \zchordsu{\hspace{-1em}Csus4}\zw{'g}\zw{'f}\wh{'c}%
  \zchordsu{C\subsc5}\zw{'g}\wh{'c}%
  \en%
  \endpiece%
\end{Music}
...
\begin{Music}
  ...
  \Lbracket{0}{5}\zq{''c}\qu{'e}%
  \Lbracket{2}{2}\zq{'b}\qu{'g}%
  \Lbracket{3}{2}\zq{''c}\ql{'a}%
  \Lbracket{1}{2}\zq{'a}\qu{'a}%
  \en\bar%
  \NOTes%
  \Lbracket{1}{3}\zh{'b}\hu{'f}%
  \en\NOtes%
  \Lbracket{0}{5}\zq{''c}\qu{'e}%
  \Lbracket{-1}{7}\zq{''d}\qu{'d}%
  \Lbracket{-2}{9}\zq{''e}\qu{'c}%
  \en\bar%
  \NOTes%
  \Lbracket{1}{5}\zh{''d}\hu{'f}%
  \Lbracket{-1}{5}\zh{'b}\hu{'d}%
  \en\bar%
  \NOTEs%
  \Lbracket{-2}{7}\zw{''c}\wh{'c}%
  \en\setdoublebar
  \endpiece%
  \Startpiece%
...
\begin{Music}
  ...
  \Startpiece%
  \Notes%
  \zchordsl{1度}\rw{'f}\wh{'f}%
  \zchordsl{2度}\rw{'g}\wh{'f}%
  \zchordsl{3度}\Lbracket{1}{2}\zw{'a}\wh{'f}%
  \zchordsl{4度}\Lbracket{1}{3}\zw{'b}\wh{'f}%
  \zchordsl{5度}\Lbracket{1}{4}\zw{''c}\wh{'f}%
  \zchordsl{6度}\Lbracket{1}{5}\zw{''d}\wh{'f}%
  \zchordsl{7度}\Lbracket{1}{6}\zw{''e}\wh{'f}%
  \zchordsl{8度}\Lbracket{1}{7}\zw{''f}\wh{'f}%
  \zchordsl{9度}\Lbracket{1}{8}\zw{''g}\wh{'f}%
  \zchordsl{10度}\Lbracket{1}{9}\zw{''a}\wh{'f}%
  \Mryaku\sk%
  \en\doublebar
  \Notes\zchordsl{全て3度}%
  \zw{'a}\wh{'f}%
...
\begin{Music}[.5\linewidth]
  ...
  \Junbkt[6度]{-2}{5}{5}\wh{'c}%
  \tinynotesize
  \nq{'d}%
  \isluru0{'e}\nq{'e}%
  \tslur0{'f}\Mhshift{-.5}{\ccharsu{全音階的半音}}\nq{'f}%
  \nq{'g}%
  \en\Notes
  \wh{_'a}%
  \en
...
\begin{Music}
  ...
  \Startpiece%
  \Notes%
  \zchordsl{1度}\zhl{'f}\hu{'f}%
  \zchordsl{8度}\zhl{'f}\hu{''f}%
  \en\bar
  \Notes%
  \zchordsl{2度}\Roff{\zhl{'g}}\hu{'f}%
  \zchordsl{7度}\zhl{'g}\hu{''f}%
  \en\bar
  \Notes%
  \zchordsl{3度}\zhl{'a}\qroff{\hu{'f}}%
  \zchordsl{6度}\zhl{'a}\hu{''f}%
  \en\bar
  \Notes%
  \zchordsl{4度}\zhl{'b}\qroff{\hu{'f}}%
  \zchordsl{5度}\zhl{'b}\hu{''f}%
  \en\setdoublebar
  \endpiece%
\end{Music}
\begin{figure}[ht]
...
\begin{Music}
  ...
  \Startpiece%
  \Notes%
  \ccharsu{下属音}\Junbkt{'f}{3}{4}\wh{'f}%
  \isluru0{'a}\ccharsu{下中音}\wh{'a}%
  \ccharsu{下主音}%
  \ccharsuu{（導音）}\wh{'b}%
  \ccharsu{主音}\tslur0{''c}\isluru0{''c}\Junbkt{''c}{3}{4}\wh{''c}%
  \ccharsu{上主音}\wh{''d}%
  \ccharsu{（上）中音}\tslur0{''e}\wh{''e}%
  \ccharsu{（上）属音}\wh{''g}%
  \en%
  \endpiece%
\end{Music}
...
\begin{Music}[.6\linewidth]
  ...
  \setclef{1}{\bass}%
  \Startpiece%
  \NOtes\en\def\atnextbar{\znotes|\centerbar{\zw{'c}\zw{'e}\zw{'g}}\en}\bar
  \notes
...
\begin{Music}[.5\linewidth]
  ...
  \en\bar%
  \Notes%
  \zchordsu{根音}\zw{'c}\zq{'e}\nq{'g}%
  \zchordsu{第三音}\zq{'c}\zw{'e}\nq{'g}%
  \zchordsu{第五音}\zq{'c}\zq{'e}\wh{'g}%
  \en%
  \endpiece%
\end{Music}
...
それぞれは次に示すように呼ばれます．
\begin{itemize}
  \item \KeyBF{長三和音}\xkanjispace(major triad)\xkanjispace：長3度と完全5度からなる
  \item \KeyBF{短三和音}\xkanjispace(minor triad)\xkanjispace：短3度と完全5度からなる
  \item \KeyBF{減三和音}\xkanjispace(diminished triad)\xkanjispace：短3度と減5度からなる
  \item \KeyBF{増三和音}\xkanjispace(augmented triad)\xkanjispace：長3度と増5度からなる
\end{itemize}
...
\begin{Music}[0.6\linewidth]
  ...
  \Startpiece
  \Notes%
  \zchordsuu{長三和音}\zchordsu{C}\zw{'c}\zw{'e}\wh{'g}%
  \zchordsuu{短三和音}\zchordsu{C\Min}\zw{'c}\zw{_'e}\wh{'g}%
  \zchordsuu{減三和音}\zchordsu{C\Dimt}\zw{'c}\fl[l]{'e}\zw{'e}\wh{_'g}%
  \zchordsuu{増三和音}\zchordsu{C\Aug}\zw{'c}\zw{'e}\wh{'g}%
  \en%
  \endpiece
\end{Music}
...
\begin{Music}[0.6\linewidth]
  ...
  \Startpiece%
  \Notes%
  \islurd0{'c}\zw{'c}\zw{'e}\wh{'g}%
  \tslur0{'g}\islurd0{'g}\cchordsu{五度関係}\zw{'g}\zw{'b}\wh{''d}%
  \tslur0{''d}\zw{''d}\zw{''f}\wh{''a}%
  \en\bar%
  \Notes%
  \islurd0{'f}\zw{'f}\zw{'a}\wh{''c}%
  \tslur0{'a}\islurd0{'a}\cchordsu{三度関係}\zw{'a}\zw{''c}\wh{''e}%
  \tslur0{''c}\zw{''c}\zw{''e}\wh{''g}%
  \en%
  \endpiece%
\end{Music}
...
\begin{Music}
  ...
  \en\doublebar%
  \Notes%
  \wh{c}|\zw{''c}\zw{'g}\wh{'e}\prevstaff%
  \en\Notes
  \figbassu[6]\wh{c}|\zw{''c}\zw{'a}\wh{'e}%
  \en\Notes
  \figbassu[4][6]\wh{c}|\zw{''c}\zw{'a}\wh{'f}%
  \en\Notes
  \figbassu[7]\wh{c}|\zw{'b}\zw{'g}\wh{'e}%
  \en\Notes
  \figbassu[5][6]\wh{c}|\rw{'a}\zw{'g}\wh{'e}%
  \en\Notes
  \figbassu[3][4][6]\wh{c}|\zw{'a}\rw{'f}\wh{'e}%
  \en\Notes
  \figbassu[2]\wh{c}|\zw{'a}\zw{'f}\wh{'d}%
  \en\setdoublebar%
  \endpiece%
\end{Music}
...
\begin{Music}
  ...
  \Startpiece%
  \Notes%
  \lchordsl{C:}\zchordsl{\Gni}\cchordsu{}\wh{c}%
  |\zw{''c}\zw{'g}\wh{'e}%
  \en%
  \Notes%
  \zchordsl{\Gni}\figbassu[6]\wh{e}%
  |\zw{''c}\zw{'g}\wh{'e}%
  \en%
  \Notes%
  \zchordsl{\Gni}\figbassu[4][6]\wh{g}%
  |\zw{''c}\zw{'g}\wh{'e}%
  \en\doublebar%
  \Notes%
  \lchordsl{C:}\zchordsl{\Gni}\wh{c}%
  |\zw{''c}\zw{'g}\wh{'e}%
  \en%
  \Notes%
  \zchordsl{\Gni\subsc6}\wh{e}%
  |\zw{''c}\zw{'g}\wh{'e}%
  \en%
  \Notes%
  \zchordsl{\Gni\subsupsc46}\wh{g}%
  |\zw{''c}\zw{'g}\wh{'e}%
  \en\doublebar%
  \Notes%
  \lchordsl{C:}\zchordsl{\Gni}\wh{c}%
  ...
  \en%
  \Notes%
  \zchordsl{\Gni\subsc1}\wh{e}%
  |\zw{''c}\zw{'g}\wh{'e}%
  \en%
  \Notes%
  \zchordsl{\Gni\subsc2}\wh{g}%
  |\zw{''c}\zw{'g}\wh{'e}%
  \en\doublebar%
  \Notes%
  \lchordsl{C Maj:}\zchordsl{\Gni}\wh{c}%
  |\zw{''c}\zw{'g}\wh{'e}%
  \en%
  \Notes%
  \zchordsl{\Gni/\Gniii}\wh{e}%
  |\zw{''c}\zw{'g}\wh{'e}%
  \en%
  \Notes%
  \zchordsl{\Gni/\Gnv}\wh{g}%
  |\zw{''c}\zw{'g}\wh{'e}%
  \en\setdoublebar%
  \endpiece%
\end{Music}
...
\begin{Music}[0.6\linewidth]
  ...
  \Startpiece%
  \Notes%
  \zchordsu{}\wh{c}|\zchordsu{C}\zw{''c}\zw{'g}\wh{'e}%
  \en%
  \Notes%
  \wh{e}|\zchordsu{C/E}\zw{''c}\zw{'g}\wh{'e}%
  \en%
  \Notes%
  \wh{g}|\zchordsu{C/G}\zw{''c}\zw{'g}\wh{'e}%
  \en\setdoublebar%
  \endpiece%
\end{Music}
...
\begin{Music}[0.6\linewidth]
  ...
  \zchordsu{C}\zw{'c}\zw{'e}\wh{'g}%
  \zchordsu{D\Min}\zw{'d}\zw{'f}\wh{'a}%
  \zchordsu{E\Min}\zw{'e}\zw{'g}\wh{'b}%
  \zchordsu{F}\zw{'f}\zw{'a}\wh{''c}%
  \zchordsu{G}\zw{'g}\zw{'b}\wh{''d}%
  \zchordsu{A\Min}\zw{'a}\zw{''c}\wh{''e}%
  \zchordsu{B\Dimt}\zw{'b}\zw{''d}\wh{''f}%
  \en
  \alaligne%
  \Notes\zcharsuu{和声的長音階上の三和音}%
  \zchordsu{C}\zw{'c}\zw{'e}\wh{'g}%
  \zchordsu{D\Dimt}\zw{'d}\zw{'f}\wh{_'a}%
  \zchordsu{E\Min}\zw{'e}\zw{'g}\wh{'b}%
  \zchordsu{F\Min}\zw{'f}\zw{_'a}\wh{''c}%
  \zchordsu{G}\zw{'g}\zw{'b}\wh{''d}%
  \zchordsu{A\aFlat\Aug}\zw{_'a}\zw{''c}\wh{''e}%
  \zchordsu{B\Dimt}\zw{'b}\zw{''d}\wh{''f}%
  \en
  \alaligne%
  ...
  \zchordsu{C}\zw{'c}\zw{'e}\wh{'g}%
  \zchordsu{D\Dimt}\zw{'d}\zw{'f}\wh{_'a}%
  \zchordsu{E\Dimt}\zw{'e}\zw{'g}\wh{_'b}%
  \zchordsu{F\Min}\zw{'f}\zw{_'a}\wh{''c}%
  \zchordsu{G\Min}\zw{'g}\zw{_'b}\wh{''d}%
  \zchordsu{A\aFlat\Aug}\zw{_'a}\zw{''c}\wh{''e}%
  \zchordsu{B\aFlat}\zw{_'b}\zw{''d}\wh{''f}%
  \en
  \endpiece%
  \generalsignature{-3}%
  \Startpiece%
  ...
  \zchordsu{C\Min}\zw{'c}\zw{'e}\wh{'g}%
  \zchordsu{D\Dimt}\zw{'d}\zw{'f}\wh{'a}%
  \zchordsu{E\aFlat}\zw{'e}\zw{'g}\wh{'b}%
  \zchordsu{F\Min}\zw{'f}\zw{'a}\wh{''c}%
  \zchordsu{G\Min}\zw{'g}\zw{'b}\wh{''d}%
  \zchordsu{A\aFlat}\zw{'a}\zw{''c}\wh{''e}%
  \zchordsu{B\aFlat}\zw{'b}\zw{''d}\wh{''f}%
  \en
  \alaligne%
  \makeatletter\hardspace{-\sign@skip}\makeatother
  \makeatletter\hardspace{.8\Internote}\makeatother
  ...
  \zchordsu{C\Min}\zw{'c}\zw{'e}\wh{'g}%
  \zchordsu{D\Dimt}\zw{'d}\zw{'f}\wh{'a}%
  \zchordsu{E\aFlat\Aug}\zw{'e}\zw{'g}\wh{='b}%
  \zchordsu{F\Min}\zw{'f}\zw{'a}\wh{''c}%
  \zchordsu{G}\zw{'g}\zw{='b}\wh{''d}%
  \zchordsu{A\aFlat}\zw{'a}\zw{''c}\wh{''e}%
  \zchordsu{B\Dimt}\zw{='b}\zw{''d}\wh{''f}%
  ...
  \zchordsu{F}\zw{'f}\zw{='a}\wh{''c}%
  \zchordsu{G}\zw{'g}\zw{='b}\wh{''d}%
  \zchordsu{A\Dimt}\zw{='a}\zw{''c}\wh{''e}%
  \zchordsu{B\Dimt}\zw{='b}\zw{''d}\wh{''f}%
  \en
  \endpiece\piececaption{各音階上の三和音．}\piecelabel{各音階上の三和音}%
\end{Music}
...
長調では\Gni ，\Gniv ，\Gnv が，
短調では\Gni\Min ，\Gniv\Min ，\Gnv がこれに当たります（\pieceref{長・短両調の主要三和音}）\footnote{%
  上属和音はその特徴を導音に持っている．
...
\begin{Music}[0.6\linewidth]
  ...
  \Startpiece%
  \Notes\lchordsl{C: }%
  \zchordsl{\Gni}\zchordsu{C}\zw{'c}\zw{'e}\wh{'g}%
  \zchordsl{\Gniv}\zchordsu{F}\zw{'f}\zw{'a}\wh{''c}%
  \zchordsl{\Gnv}\zchordsu{G}\zw{'g}\zw{'b}\wh{''d}%
  \en%
  \generalsignature{-3}%
  \changecontext%
  \Notes\lchordsl{c: }%
  \zchordsl{\Gni\Min}\zchordsu{C\Min}\zw{'c}\zw{'e}\wh{'g}%
  \zchordsl{\Gniv\Min}\zchordsu{F\Min}\zw{'f}\zw{'a}\wh{''c}%
  \zchordsl{\Gnv}\zchordsu{G}\zw{'g}\zw{='b}\wh{''d}%
  \en%
  \endpiece%
...
短調においては和声的短音階）が出現していることが分かります（\pieceref{主要三和音の五度関係性}）．

\begin{Music}[.6\linewidth]
  \nostartrule%
  \Startpiece%
  \Notes\lchordsll{C: }%
  \zchordsll{\Gniv}\zw{f}\zw{a}\wh{'c}%
  \zchordsll{\Gni}\zw{'c}\zw{'e}\wh{'g}%
  \zchordsll{\Gnv}\zw{'g}\zw{'b}\wh{''d}%
  \en\generalsignature{-3}\changecontext%
  \Notes\lchordsll{c: }%
  \zchordsll{\Gniv\Min}\zw{f}\zw{a}\wh{'c}%
  \zchordsll{\Gni\Min}\zw{'c}\zw{'e}\wh{'g}%
  \zchordsll{\Gnv}\zw{'g}\zw{='b}\wh{''d}%
  \en%
  \endpiece
...
\begin{Music}
  ...
  \en\setdoublebar%
  \endpiece
  \piececaption{プレドミナント(a)とプラガル(b)．}\piecelabel{プレドミナントとプラガル}%
\end{Music}
\end{Yodan}
...
これらは\pieceref{カデンツ素片}のように連結する可能性を考えることができます\cite[p.22]{chTHUILLE1}．
\begin{enumerate}
...
\begin{Music}
  ...
  \Startpiece
  \NOTes%
  \ha{c}|\zchordsu{C}\zh{''c}\zh{'g}\hu{'e}%
  \en%
  \NOTes%
  \ha{g}|\zchordsu{G}\zh{'b}\zh{'g}\hu{'d}%
  \en\doublebar%
  \NOTes%
  \ha{c}|\zchordsu{C}\zh{''c}\zh{'g}\hu{'e}%
  \en%
  \NOTes%
  \ha{f}|\zchordsu{F}\zh{''c}\zh{'a}\hu{'c}%
  \en\doublebar%
  \NOTes%
  \ha{g}|\zchordsu{G}\zh{'b}\zh{'g}\hu{'d}%
  \en%
  ...
  \en\doublebar%
  \NOTes%
  \ha{g}|\zchordsu{G}\zcharsuu{まれ}\zh{'b}\zh{'g}\hu{'d}%
  \en%
  \NOTes%
  \ha{f}|\zchordsu{F}\zh{''c}\zh{'a}\hu{'f}%
  \en\setdoublebar%
  \endpiece
  \piececaption{主要三和音の連結例．}\piecelabel{カデンツ素片}%
\end{Music}
...
}というのが\pieceref{カデンツの3種の例}のように形作られます．
...
\begin{Music}
  ...
  \en\setdoublebar%
  \endpiece
  \piececaption{カデンツの3種の例．}\piecelabel{カデンツの3種の例}%
\end{Music}
...
（\pieceref{長・短両調での主要三和音と副三和音の三度関係性}）．
...
\begin{floatMusic}[pos=ht]
  ...
  \NOTes
  \zchordsl{\Funktion{Sp}}\ha{d}%
  \zchordsl{\Funktion{D\Hochgestellt{7}}}\ha{g}%
  |\zchordsu{D\Min}\zh{''d}\zh{'a}\hu{'f}%
  ...
  \en\doublebar
  \NOTEs
  \zchordsl{\Funktion{Sp}}\wh{d}%
  |\zchordsu{D\Min}\zw{''d}\zw{'a}\wh{'f}%
  \en\bar
  \NOTEs
  \zchordsl{\Funktion{T}}\wh{c}%
  ...
  \en\bar
  \NOTes
  \zchordsl{\Funktion{D\Hochgestellt{7}}}\ha{g}\Mryaku\sk%
  |\zchordsu{G\subsc7}\zh{'b}\rh{'g}\hu{'f}%
  \Mryaku\sk
  \en\setdoublebar
  \endpiece%
  \piececaption{\Funktion{S}の代理としての\Gnii\Min}%
  \piecelabel{Sの代理としてのIIm}%
\end{floatMusic}
...
\begin{floatMusic}[pos=ht]
  ...
  \znotes|\zcharsuu{Substitute for \Funktion{S}}\en
  \NOTes
  \zchordsl{\Funktion{S\Hochgestellt{6}}}\ha{f}%
  \zchordsl{\Funktion{D\Hochgestellt{7}}}\ha{g}%
  |\zchordsu{D\Min/F}\zh{''d}\zh{'a}\hu{'f}%
  \zchordsu{G\subsc7}\zh{'b}\rh{'g}\hu{'f}%
  \en\bar
  \NOTEs
  \zchordsl{\Funktion{T}}\wh{c}%
  ...
  \en\doublebar
  \NOTEs
  \zchordsl{\Funktion{S\Hochgestellt{6}}}\wh{f}%
  |\zchordsu{D\Min/F}\zw{''d}\zw{'a}\wh{'f}%
  \en\bar
  \NOTEs
  \zchordsl{\Funktion{T}}\wh{c}%
  |\zchordsu{C}\zw{''e}\zw{''c}\wh{'g}%
  \en\doublebar
  \NOTes
  \zchordsl{\Funktion{S\Hochgestellt{5}}}\wh{f}%
  \zchordsl{\Funktion{\Mdline\Hochgestellt{6}}}\sk%
  |\zchordsu{F}\zhu{''c}\zw{'a}\wh{'f}%
  \zchordsu{D\Min/F}\hu{''d}%
  \en\bar
  \NOTes
  \zchordsl{\Funktion{D\Hochgestellt{7}}}\ha{g}\Mryaku\sk%
  |\zchordsu{G\subsc7}\zh{'b}\rh{'g}\hu{'f}%
  ...
  \en\setdoublebar
  \endpiece%
  \piececaption{\Funktion{S\Hochgestellt{6}}としての\Gnii\Min/\Gniv}%
  \piecelabel{IImの1転}%
\end{floatMusic}
...
\begin{floatMusic}[pos=ht]
  ...
  \znotes|\zcharsuu{Substitute for \Funktion{S}}\en
  \NOTes
  \zchordsl{\Funktion{\tiefgestellt{s}{6}}}\ha{d}%
  \zchordsl{\Funktion{D\Hochgestellt{7}}}\ha{g}%
  ...
  \en\doublebar
  \NOTEs
  \zchordsl{\Funktion{\tiefgestellt{s}{6}}}\wh{d}%
  |\zchordsu{D\Dimt}\fl{'a}\zh{''d}\zh{'a}\hu{'f}%
  \en\bar
  \NOTEs
  \zchordsl{\Funktion{T}}\wh{c}%
...
そのためこの和音は，第一にはドミナント・コード\Funktion{D}の代理として（\pieceref{Dの代理としてのIIIm}），
第二にはトニック・コード\Funktion{T}の代理としての役割を果たすと言えるでしょう
（\pieceref{Tの代理としてのIIIm}）．
...
\begin{floatMusic}[pos=ht]
  ...
  \NOTes
  \zchordsl{\Funktion{S}}\ha{f}%
  \zchordsl{\Funktion{D\Hochgestellt{6}}}\ha{g}%
  |\zchordsu{F}\zh{''c}\zh{'a}\hu{'c}%
  \zchordsu{E\Min/G}\MlineB{'b}{1}\zh{'b}\zh{'g}\hu{'e}%
  \en\bar
  \NOTEs
  \zchordsl{\Funktion{T}}\wh{c}%
  |\zchordsu{C}\zw{''c}\zw{'g}\wh{'e}%
  \en\doublebar
  \NOTes
  \zchordsl{\Funktion{S\Hochgestellt{\subsupsc56}}}\ha{f}%
  \zchordsl{\Funktion{D\Hochgestellt{6}}}\ha{g}%
  |\zchordsu{F\subsc6}\zh{''d}\lh{''c}\hl{'a}%
  \zchordsu{E\Min/G}\MlineB{'b}{-2}\zh{''e}\zh{'b}\hl{'g}%
  \en\bar
  \NOTEs
  \zchordsl{\Funktion{T}}\wh{c}%
  |\zchordsu{C}\zw{''c}\zw{'g}\wh{'e}%
  ...
  \NOTes
  \zchordsl{\Funktion{D\Hochgestellt{6}}}\ha{G}%
  |\zchordsu{E\Min/G}\MlineB{'b}{-2}\zh{'b}\zh{'g}\hu{'e}%
  \en\bar
  \NOTEs
  \zcharsu{?}\zchordsl{\Funktion{T}}\wh{c}%
  |\zchordsu{C}\rw{'g}\zw{'g}\wh{'e}%
  \en\doublebar
  \NOTes
  \zchordsl{\Funktion{S}}\ha{f}%
  \zchordsl{\Funktion{Dp}}\ha{e}%
  |\zchordsu{F}\zh{''c}\zh{'a}\hu{'c}%
  \zchordsu{E\Min}\MlineB{'b}{1}\zh{'b}\zh{'g}\hu{'e}%
  \en\bar
  \NOTEs
...
\begin{floatMusic}[pos=ht]
  ...
  \NOTes
  \zchordsl{\Funktion{T\Hochgestellt{8}}}\ha{c}%
  \zchordsl{\Funktion{\tiefgestellt{\Mdline}{3}\Hochgestellt{7}}}\ha{e}%
  |\zchordsu{C}\zh{''c}\zh{'g}\hu{'e}%
  \zchordsu{E\Min}\MlineB{'b}{-1}\zh{'b}\zh{'g}\hu{'e}%
  \en\bar
  \NOTes
  \zchordsl{\Funktion{S}}\ha{f}\Mryaku\sk%
  |\zchordsu{F}\zh{'a}\zh{'f}\hu{'c}\Mryaku\sk%
  \en\doublebar
  \NOTes
...
変じられたLa\aFlat は調の上属音への下行導音として働くことがあります（\pieceref{Sの代理としてのIVm}）．
...
\begin{floatMusic}[pos=ht]
  ...
  \zchordsl{\Funktion{s}}\ha{f}%
  \zchordsl{\Funktion{D}}\ha{g}%
  |\zchordsu{F\Min}\MlineC{'a}{-1}\zh{''c}\zh{_'a}\hu{'f}%
  \zchordsu{G\subsc7}\zh{'b}\rh{'g}\hu{'f}%
  \en\bar
  \NOTEs
  \zchordsl{\Funktion{T}}\wh{c}%
  ...
  \en\doublebar
  \NOTEs
  \zchordsl{\Funktion{s}}\wh{f}%
  |\zchordsu{F\Min}\MlineB{'a}{-1}\zw{''c}\zw{_'a}\wh{'f}%
  \en\bar
  \NOTEs
  \zchordsl{\Funktion{T}}\wh{c}%
  |\zchordsu{C}\zw{''c}\zw{'g}\wh{'e}%
  ...
  \zchordsl{\Mdline}\sk%
  |\zchordsu{F}\zh{''c}\zh{'a}\hu{'f}%
  \zchordsu{F\Min}\zh{''c}\zh{_'a}\hu{'f}%
  \en\bar
  \NOTes
  \zchordsl{\Funktion{D}}\ha{g}\Mryaku\sk%
  |\zchordsu{G\subsc7}\zh{'b}\rh{'g}\hu{'f}%
  \Mryaku\sk
  \en\setdoublebar
  \endpiece%
  \piececaption{\Funktion{S}の代理としての\Gniv\Min}%
  \piecelabel{Sの代理としてのIVm}%
\end{floatMusic}
...
（\pieceref{Tの代理としてはbVIaugは働かない}）．
そのため，共通音の関係からは\Gniv\Min の持つサブドミナントの代理の性質を持つといえます
（\pieceref{Sの代理としてのbVIaug}）．
...
\begin{floatMusic}[pos=ht]
  ...
  \NOTEs
  \zchordsl{T?}\wh{c}%
  |\zchordsu{A\aFlat\Aug/C}\zw{''c}\zw{_'a}\wh{'e}%
  \en\setdoublebar
  \endpiece%
  \piececaption{\Funktion{T}の代理としては\bFlat\Gnvi\Aug は働かない．}%
  \piecelabel{Tの代理としてはbVIaugは働かない}%
\end{floatMusic}
...
\begin{floatMusic}[pos=ht]
  ...
  \znotes|\zcharsuu{Substitute for \Funktion{S}}\en
  \NOTes
  \zchordsl{\Funktion{\tiefgestellt{\Slash{s}}{3}\hochgestellt{7}}}\ha{_a}%
  \zchordsl{\Funktion{D}}\ha{g}%
  |\zchordsu{A\aFlat\Aug}\zh{''c}\zh{'e}\hu{'c}%
  ...
  \NOTEs
  \zchordsl{\Funktion{T}}\wh{c}%
  |\zchordsu{C}\zw{''c}\zw{'e}\wh{'c}%
  \en\doublebar
  \NOTEs
  \zchordsl{\Funktion{\tiefgestellt{\Slash{s}}{3}\hochgestellt{7}}}\wh{_A}%
  |\zchordsu{A\aFlat\Aug}\zw{_'a}\zw{'e}\wh{'c}%
  \en\bar
  \NOTEs
  \zchordsl{\Funktion{T}}\wh{c}%
  |\zchordsu{C}\zw{'g}\zw{'e}\wh{'c}%
...
そのためこの和音は，第一にはトニック・コードの代理として（\pieceref{Tの代理としてのVIm}），
第二にはサブドミナント・コードの代理としての役割を果たすと言えるでしょう（\pieceref{Sの代理としてのVIm}）．
...
\begin{floatMusic}[pos=ht]
  ...
  \zchordsl{\Funktion{D}}\ha{g}%
  |\zchordsu{F}\zh{''c}\zh{'a}\hu{'f}%
  \zchordsu{G}\MlineB{4}{-1}\zh{'b}\zh{'g}\hu{'d}%
  \en\bar
  \NOTEs
  \zcharsl{\Funktion{Tp}}\wh{a}%
  |\zchordsu{A\Min}\zw{'a}\zw{'e}\wh{'c}%
  \en\doublebar
  \znotes|\lcharsu{b)\ }\en
  \NOTEs
  \zchordsl{\Funktion{S}}\wh{f}%
  ...
  \en\bar
  \NOTEs
  \zchordsl{\Funktion{T\Hochgestellt{6}}}\wh{c}%
  |\zchordsu{A\Min/C}\zw{''c}\zw{'a}\wh{'e}%
  \en\setdoublebar
  \endpiece%
  \piececaption{\Funktion{T}の代理としての\Gnvi\Min}%
  \piecelabel{Tの代理としてのVIm}%
\end{floatMusic}
...
\begin{NB}
  この導音の例外処理は立場によって許容するかどうかが変わります：
  \citetitle{chSHIMAOKA1i}や\citetitle{chDUBOIS1}のようなより厳格な態度を取る立場では
  \Funktion{D}---\Funktion{Tp}のような進行にあっても導音の2度下行は
  \begin{itemize}
    \item ソプラノがRe---Doと下行し，
    \item アルトがSi---Laと下行する
  \end{itemize}
  場合に限るという制限を課せられます（\sectref{属七の和音}も参照）．
\end{NB}
...
\begin{floatMusic}[pos=ht]
  ...
  \znotes|\zcharsuu{Substitute for \Funktion{S}}\en
  \NOTes
  \zchordsl{\Funktion{Sg}}\ha{a}%
  \zchordsl{\Funktion{D}}\ha{g}%
  |\zchordsu{A\Min}\zh{''c}\zh{'e}\hu{'c}%
  \zchordsu{G\subsc7}\zh{'b}\zh{'f}\hu{'d}%
  \en\bar
  \NOTEs
  \zchordsl{\Funktion{T}}\wh{c}%
...
（\pieceref{Dの代理としてのVIIdim}）\footnote{%
...
\begin{floatMusic}[pos=ht]
  ...
  \NOTes
  \zchordsl{\Funktion{\tiefgestellt{S}{3}}}\ha{A}%
  \zchordsl{\Funktion{\tiefgestellt{\Slash{D}}{3}\hochgestellt{7}}}\MlineB{B}{1}\ha{B}%
  |\zchordsu{F/A}\zh{''c}\rh{'f}\hu{'f}%
  \zchordsu{B\Dimt}\zh{''d}\zh{'f}\hu{'d}%
  \en\bar
  \NOTEs
  \zchordsl{\Funktion{T}}\wh{c}%
  |\zchordsu{C}\zw{''c}\rw{'e}\wh{'e}%
  \en\doublebar
  \NOTes
  \zchordsl{\Funktion{S\Hochgestellt{\subsupsc35}}}\wh{f}%
  \zchordsl{\Funktion{\tiefgestellt{\Slash{\Funktion{D}}}{7}}}\sk%
  |\zchordsu{F}\zh{''c}\zh{'a}\hu{'f}%
  \zchordsu{\hspace{-0.5em}B\Dimt/F}\MlineB{'b}{-2}\zh{''d}\zh{'b}\hu{'d}%
  \en\bar
  \NOTEs
  \zchordsl{\Funktion{T}}\wh{c}%
  |\zchordsu{C}\zw{''c}\zw{'g}\wh{'e}%
  \en\doublebar
  \NOTes
  \zchordsl{\Funktion{\tiefgestellt{\Slash{D}}{5}\hochgestellt{7}}}\ha{d}%
  |\zchordsu{\hspace{-0.5em}B\Dimt/D}\MlineB{'f}{1}\zh{'b}\zh{'f}\hu{'d}%
  \en\bar
  \NOTEs
  \zchordsl{\Funktion{T}}\wh{c}%
  |\zchordsu{C}\zw{''c}\zw{'g}\wh{'e}%
  \en\doublebar
  \NOTes
  \zchordsl{\Funktion{\tiefgestellt{D}{3}\Hochgestellt{8}}}\ha{B}%
  \zchordsl{\Funktion{\Mdline\Hochgestellt{7}}}\MlineB{B}{1}\ha{B}%
  |\zchordsu{G/B}\zh{''d}\zh{'g}\hu{'d}%
  \zchordsu{B\Dimt}\zh{''d}\zh{'f}\hu{'d}%
  \en\bar
  \NOTEs
  \zchordsl{\Funktion{T}}\wh{c}%
...
\begin{floatMusic}[pos=ht]%[.5\linewidth]
  ...
  \zchordsl{\Funktion{\tiefgestellt{s}{6}}}\ha{d}%
  \zchordsl{\Funktion{D\Hochgestellt{7}}}\ha{g}%
  |\zchordsu{D\Dimt}\zh{''d}\zh{'a}\hu{'f}%
  \zchordsu{G\subsc7}\zh{='b}\rh{'g}\hu{'f}%
  \en\bar
  \NOTEs
  \zchordsl{\Funktion{t}}\wh{c}%
  ...
  \NOTEs
  \zchordsl{\Funktion{t}}\wh{c}%
  |\zchordsu{C\Min}\zw{''e}\zw{''c}\wh{'g}%
  \en\doublebar
  \NOTes
  \zchordsl{\Funktion{s}}\ha{f}%
  \zchordsl{\Funktion{\tiefgestellt{\Mdline}{6}}}\ha{d}%
  |\zchordsu{F\Min}\zh{''c}\zh{'a}\hu{'f}%
  \zchordsu{D\Dimt}\zh{''d}\zh{'a}\hu{'f}%
  \en\bar
  \NOTes
  \zchordsl{\Funktion{D}}\ha{g}\Mryaku\sk%
...
\begin{floatMusic}[pos=ht]
  ...
  \zchordsl{\Funktion{s}}\ha{f}%
  \zchordsl{\Funktion{d\hochgestellt{6}}}\ha{g}%
  |\zchordsu{F\Min}\zh{''c}\zh{'a}\hu{'c}%
  \zchordsu{E\aFlat/G}\MlineB{'b}{1}\zh{'b}\zh{'g}\hu{'e}%
  \en\bar
  \NOTEs
  \zcharsu{?}\zchordsl{\Funktion{t}}\wh{c}%
  |\zchordsu{C\Min}\zw{''c}\zw{'g}\wh{'e}%
  ...
  \zchordsl{\Funktion{s}}\ha{f}%
  \zchordsl{\Funktion{d\hochgestellt{6}}}\ha{g}%
  |\zchordsu{F\Min\subsc6}\zh{''d}\lh{''c}\hl{'a}%
  \zchordsu{E\aFlat/G}\MlineB{'b}{-2}\zh{''e}\zh{'b}\hl{'g}%
  \en\bar
  \NOTEs
  \zcharsu{?}\zchordsl{\Funktion{t}}\wh{'c}%
  |\zchordsu{C\Min}\zw{''c}\zw{'g}\wh{'e}%
  ...
  \NOTes
  \zchordsl{\Funktion{d\hochgestellt{6}}}\ha{G}%
  |\zchordsu{E\aFlat/G}\MlineB{'b}{-2}\zh{'b}\zh{'g}\hu{'e}%
  \en\bar
  \NOTEs
  \zcharsu{?}\zchordsl{\Funktion{t}}\wh{c}%
  |\zchordsu{C\Min}\rw{'g}\zw{'g}\wh{'e}%
  \en\doublebar
  \znotes|\zcharsuu{Substitute for \Funktion{T}}\en
  \NOTes
  \zchordsl{\Funktion{t}}\ha{c}%
  \zchordsl{\Mdline}\ha{e}%
  |\zchordsu{C\Min}\zh{''c}\zh{'g}\hu{'e}%
  \zchordsu{E\aFlat}\MlineB{'b}{-1}\zh{'b}\zh{'g}\hu{'e}%
  \en\bar
  \NOTes
  \zchordsl{\Funktion{s}}\ha{f}\Mryaku\sk%
...
（\pieceref{Dの代理としてのbIIIaug}）．
トニック・コードの代理と見なさないのは長調の\bFlat\Gnvi\Aug のときと同様です
（\pieceref{tの代理としてはbIIIaugは働かない}）．
...
\begin{floatMusic}[pos=ht]
  ...
  \zchordsl{\Funktion{D\hochgestellt{6}}}\ha{g}%
  |\zchordsu{F\Min}\zh{''c}\zh{'a}\hu{'c}%
  \zchordsu{E\aFlat\Aug/G}\MlineB{'b}{1}\zh{='b}\zh{'g}\hu{'e}%
  \en\bar
  \NOTEs
  \zchordsl{\Funktion{t}}\wh{c}%
  |\zchordsu{C\Min}\zw{''c}\zw{'g}\wh{'e}%
  ...
  \zchordsl{\Funktion{D\hochgestellt{6}}}\ha{g}%
  |\zchordsu{F\Min\subsc6}\zh{''d}\lh{''c}\hl{'a}%
  \zchordsu{E\aFlat\Aug/G}\MlineB{'b}{-2}\zh{''e}\zh{='b}\hl{'g}%
  \en\bar
  \NOTEs
  \zchordsl{\Funktion{t}}\wh{c}%
  |\zchordsu{C\Min}\zw{''c}\zw{'g}\wh{'e}%
  ...
  \NOTes
  \zchordsl{\Funktion{D\hochgestellt{6}}}\ha{G}%
  |\zchordsu{E\aFlat\Aug/G}\MlineB{'b}{-2}\zh{='b}\zh{'g}\hl{'e}%
  \en\bar
  \NOTEs
  \zcharsu{?}\zchordsl{\Funktion{t}}\wh{c}%
  |\zchordsu{C\Min}\rw{'g}\zw{'g}\wh{'e}%
...
\begin{floatMusic}[pos=ht]
  ...
  \zchordsu{E\aFlat\Aug}\MlineB{'b}{-1}\hu{='b}%
  \en\bar
  \NOTes
  ...
  |\zchordsu{C\Min}\zhu{''c}\zw{'g}\wh{'e}%
  \zchordsu{E\aFlat\Aug/G}\MlineB{'b}{1}\hu{='b}%
  \en\bar
  \NOTes
  \zchordsl{\Funktion{s}}\ha{f}\Mryaku\sk%
  ...
  \piecelabel{tの代理としてはbIIIaugは働かない}%
\end{floatMusic}
...
\begin{floatMusic}[pos=ht]
  ...
  \zchordsl{\Funktion{d}}\ha{g}%
  |\zchordsu{F\Min}\zh{''c}\zh{'a}\hu{'c}%
  \zchordsu{G\Min}\MlineB{'b}{1}\zh{'b}\zh{'g}\hu{'d}%
  \en\bar
  \NOTEs
  \zcharsu{?}\zchordsl{\Funktion{t}}\wh{c}%
  |\zchordsu{C\Min}\zw{''c}\zw{'g}\wh{'e}%
  ...
  \zchordsl{\Funktion{d}}\ha{g}%
  |\zchordsu{F\Min\subsc6}\zh{''d}\lh{''c}\hl{'a}%
  \zchordsu{G\Min}\MlineB{'b}{-2}\zh{''d}\zh{'b}\hl{'g}%
  \en\bar
  \NOTEs
  \zcharsu{?}\zchordsl{\Funktion{t}}\wh{c}%
  |\zchordsu{C\Min}\zw{''c}\zw{'g}\wh{'e}%
  ...
  \NOTes
  \zchordsl{\Funktion{d}}\ha{G}%
  |\zchordsu{G\Min}\MlineB{'b}{-2}\zh{'b}\zh{'g}\hu{'d}%
  \en\bar
  \NOTEs
  \zcharsu{?}\zchordsl{\Funktion{t}}\wh{c}%
  |\zchordsu{C\Min}\rw{'g}\zw{'g}\wh{'e}
...
\begin{floatMusic}[pos=ht]
  ...
  \zchordsl{\Funktion{d}}\ha{g}%
  \zchordsl{\Funktion{\tiefgestellt{s}{3}}}\ha{a}%
  |\zchordsu{G\Min}\MlineC{'b}{-1}\zh{'b}\zh{'g}\hu{'d}%
  \zchordsu{F\Min/A\aFlat}\zh{'a}\zh{'f}\hu{'c}%
  \en\bar
  \NOTes
  \zchordsl{\Funktion{s}}\ha{f}%
  \zchordsl{\Funktion{D}}\ha{g}%
  |\zchordsu{F\Min}\zh{''c}\zh{'a}\hu{'f}%
  \zchordsu{G}\MlineB{'b}{1}\zh{='b}\zh{'g}\hu{'d}%
  \en\bar
  \NOTes
  \zchordsl{\Funktion{t}}\wh{c}%
  |\zchordsu{C\Min}\zw{''c}\zw{'g}\wh{'e}%
...
\begin{floatMusic}[pos=ht]
  ...
  \en\bar
  \NOTEs
  \zcharsl{\Funktion{tG}}\wh{a}%
  |\zchordsu{A\aFlat}\zw{''c}\zw{'e}\wh{'c}%
  \en\doublebar
  \znotes|\lcharsu{a')\ }\en
  \NOTes
  \zchordsl{\Funktion{s}}\ha{f}%
  ...
  \NOTEs
  \zchordsl{\Funktion{t\hochgestellt{6}}}\wh{c}%
  |\zchordsu{A\aFlat/C}\zw{''c}\zw{'a}\wh{'e}%
  \en\setdoublebar
  \endpiece%
  \piececaption{\Funktion{t}の代理としての\bFlat\Gnvi}%
  \piecelabel{tの代理としてのbVI}%
\end{floatMusic}
...
\begin{floatMusic}[pos=ht]
  ...
  \znotes|\zcharsuu{Substitute for \Funktion{S}}\en
  \NOTes
  \zchordsl{\Funktion{sP}}\ha{a}%
  \zchordsl{\Funktion{D}}\ha{g}%
  |\zchordsu{A\aFlat}\zh{''c}\zh{'e}\hu{'c}%
  \zchordsu{G\subsc7}\zh{='b}\zh{'f}\hu{'d}%
  \en\bar
  \NOTEs
  \zchordsl{\Funktion{t}}\wh{c}%
  |\zchordsu{C\Min}\zw{''c}\zw{'e}\wh{'c}%
  \en\doublebar
  \NOTEs
  \zchordsl{\Funktion{sP}}\wh{A}%
  |\zchordsu{A\aFlat}\zw{'a}\zw{'e}\wh{'c}%
  \en\bar
  \NOTEs
  \zchordsl{\Funktion{t}}\wh{c}%
  ...
  \zchordsl{\Funktion{sP}}\ha{a}%
  \zchordsl{s}\ha{f}%
  |\zchordsu{A\aFlat}\zh{'a}\zh{'e}\hu{'c}%
  \zchordsu{F\Min}\zh{''c}\zh{'a}\hu{'c}%
  \en\bar
  \NOTes
  \zchordsl{\Funktion{D}}\ha{g}\Mryaku\sk%
...
\begin{floatMusic}[pos=ht]
  ...
  \NOTes
  \zchordsl{\Funktion{S}}\ha{f}%
  \lrchordsll{Es: &\Funktion{D}}\zchordsl{\Funktion{dP}}\ha{B}%
  |\zchordsu{F\Min}\zh{''c}\zh{'a}\hu{'c}%
  \zchordsu{B\aFlat}\zh{'b}\zh{'f}\hu{'d}%
  \en\bar
  \NOTEs
  \zchordsll{\Funktion{Tp}}\zchordsl{\Funktion{t}}\wh{c}%
  |\zchordsu{C\Min}\zw{'g}\rw{'e}\wh{'e}%
  \en\doublebar
  \NOTes
  \zchordsl{\Funktion{s\hochgestellt{\subsupsc56}}}\ha{f}%
  \zchordsl{\Funktion{dP}}\ha{g}%
  |\zchordsu{F\Min\subsc6}\zh{''d}\lh{''c}\hl{'a}%
  \zchordsu{B\aFlat}\MlineB{'b}{-2}\zh{''d}\zh{'b}\hl{'f}%
  \en\bar
  \NOTEs
  \zchordsl{\Funktion{t}}\wh{c}%
  |\zchordsu{C\Min}\zw{''c}\zw{'g}\wh{'e}%
  \en\doublebar
  \NOTes
  \zchordsl{\Funktion{dP}}\ha{B}%
  |\zchordsu{B\aFlat}\MlineB{'b}{-2}\zh{'b}\zh{'f}\hu{'d}%
  \en\bar
  \NOTEs
  \zchordsl{\Funktion{t}}\wh{c}%
  |\zchordsu{C\Min}\zw{'g}\rw{'e}\wh{'e}%
...
\begin{floatMusic}[pos=ht]
  ...
  \piecelabel{bVIIのd-sカデンツ}%
\end{floatMusic}

平行長調の上属和音と区別されるとき，この和音の根音は下行します
（\pieceref{bVIIのd-sカデンツ}）．
...
それをもってドミナント・コードの代理としての役割を果たすと考えています
（\pieceref{Dの代理としてのVIIdim in minor}）．
...
\begin{floatMusic}[pos=ht]
  ...
  \znotes|\zcharsuu{Substitute for \Funktion{D}}\en
  \NOTes
  \zchordsl{\tiefgestellt{\Funktion{S}}{3}}\zcharsu{N.B.}\ha{=A}%
  \zchordsl{\tiefgestellt{\Slash{\Funktion{D}}}{3}\supsc{7}}\MlineB{B}{1}\ha{=B}%
  |\zchordsu{F/A}\zh{''c}\rh{'f}\hu{'f}%
  \zchordsu{B\Dimt}\zh{''d}\zh{'f}\hu{'d}%
  \en\bar
  \NOTEs
  \zchordsl{\Funktion{t}}\wh{c}%
  |\zchordsu{C\Min}\zw{''c}\rw{'e}\wh{'e}%
  \en\doublebar
  \NOTes
  \zchordsl{\Funktion{s}}\wh{f}%
  \zchordsl{\tiefgestellt{\Slash{\Funktion{D}}}{7}}\sk%
  |\zchordsu{F\Min}\zh{''c}\zh{'a}\hu{'f}%
  \zchordsu{B\Dimt/F}\MlineB{'b}{-2}\zh{''d}\zh{='b}\hu{'d}%
  \en\bar
  \NOTEs
  \zchordsl{\Funktion{t}}\wh{c}%
  |\zchordsu{C\Min}\zw{''c}\zw{'g}\wh{'e}%
  \en\doublebar
  \NOTes
  \zchordsl{\tiefgestellt{\Slash{\Funktion{D}}}{5}\supsc{7}}\ha{d}%
  |\zchordsu{B\Dimt/D}\MlineB{'f}{1}\zh{='b}\zh{'f}\hu{'d}%
  \en\bar
  \NOTEs
  \zchordsl{\Funktion{t}}\wh{c}%
  |\zchordsu{C\Min}\zw{''c}\zw{'g}\wh{'e}%
  ...
  \endpiece%
  \piececaption{\Funktion{D}の代理としての\Gnvii\Dimt}%
  \piecelabel{Dの代理としてのVIIdim in minor}%
\end{floatMusic}
...
T.~Duboisの和声学では和音の連結規則について，「和音の連結は根音によつて規定される」\cite[p.35]{chDUBOIS1}と
述べています．
...
なお\Gnv---\Gniv の連結は三全音の対斜の悪作用を生じるもの\footnote{%
  ...
  「導音が最上音部にあつて主音に上行する時，
  増四度の音程をなす二音が最上音部と低音部とに連續して聞かれる」\cite[p.18]{chDUBOIS1}場合には
...
\begin{Music}
  ...
  \Notes%
  \zchordsu{C\subsc{\Maj7}}\zw{'c}\zw{'e}\zw{'g}\wh{'b}\en%
  \Notes%
  \zchordsu{D\Min\subsc7}\zw{'d}\zw{'f}\zw{'a}\wh{''c}\en%
  \Notes%
  \zchordsu{E\Min\subsc7}\zw{'e}\zw{'g}\zw{'b}\wh{''d}\en%
  \Notes%
  \zchordsu{F\subsc{\Maj7}}\zw{'f}\zw{'a}\zw{''c}\wh{''e}\en%
  \Notes%
  \zchordsu{G\subsc7}\zw{'g}\zw{'b}\zw{''d}\wh{''f}\en%
  \Notes%
  \zchordsu{A\Min\subsc7}\zw{'a}\zw{''c}\zw{''e}\wh{''g}\en%
  \Notes%
  \zchordsu{B\hDim\subsc7}\zw{'b}\zw{''d}\zw{''f}\wh{''a}\en%
  \alaligne%
  \znotes\zchordsuu{和声的長音階}\en%
  \Notes%
  \zchordsu{C\subsc{\Maj7}}\zw{'c}\zw{'e}\zw{'g}\wh{'b}\en%
  \Notes%
  \zchordsu{D\hDim\subsc7}\zw{'d}\zw{'f}\zw{_'a}\wh{''c}\en%
  \Notes%
  \zchordsu{E\Min\subsc7}\zw{'e}\zw{'g}\zw{'b}\wh{''d}\en%
  \Notes%
  \zchordsu{F\Min\subsc{\Maj7}}\zw{'f}\zw{_'a}\zw{''c}\wh{''e}\en%
  \Notes%
  \zchordsu{G\subsc7}\zw{'g}\zw{'b}\zw{''d}\wh{''f}\en%
  \Notes%
  \zchordsu{A\aFlat\Aug\subsc{\Maj7}}\zw{_'a}\zw{''c}\zw{''e}\wh{''g}\en%
  \Notes%
  \zchordsu{B\Dim\subsc7}\zw{'b}\zw{''d}\zw{''f}\wh{_''a}\en%
  \alaligne%
  \znotes\zchordsuu{旋律的長音階}\en%
  \Notes%
  \zchordsu{C\subsc7}\zw{'c}\zw{'e}\zw{'g}\wh{_'b}\en%
  \Notes%
  \zchordsu{D\hDim\subsc7}\zw{'d}\zw{'f}\zw{_'a}\wh{''c}\en%
  \Notes%
  \zchordsu{E\hDim\subsc7}\zw{'e}\zw{'g}\zw{_'b}\wh{''d}\en%
  \Notes%
  \zchordsu{F\Min\subsc{\Maj7}}\zw{'f}\zw{_'a}\zw{''c}\wh{''e}\en%
  \Notes%
  \zchordsu{G\Min\subsc7}\zw{'g}\zw{_'b}\zw{''d}\wh{''f}\en%
  \Notes%
  \zchordsu{A\aFlat\Aug\subsc{\Maj7}}\zw{_'a}\zw{''c}\zw{''e}\wh{''g}\en%
  \Notes%
  \zchordsu{B\aFlat\subsc7}\zw{_'b}\zw{''d}\zw{''f}\wh{_''a}\en%
  \endpiece%
  \nostartrule\generalsignature{-3}%
  \Startpiece%
  \makeatletter\hardspace{-\sign@skip}\makeatother
  \makeatletter\hardspace{.8\Internote}\makeatother
  \znotes\zchordsuu{自然的短音階}\en%
  \Notes%
  \zchordsu{C\Min\subsc7}\zw{'c}\zw{'e}\zw{'g}\wh{'b}\en%
  \Notes%
  \zchordsu{D\hDim\subsc7}\zw{'d}\zw{'f}\zw{'a}\wh{''c}\en%
  \Notes%
  \zchordsu{E\aFlat\subsc{\Maj7}}\zw{'e}\zw{'g}\zw{'b}\wh{''d}\en%
  \Notes%
  \zchordsu{F\Min\subsc7}\zw{'f}\zw{'a}\zw{''c}\wh{''e}\en%
  \Notes%
  \zchordsu{G\Min\subsc7}\zw{'g}\zw{'b}\zw{''d}\wh{''f}\en%
  \Notes%
  \zchordsu{A\aFlat\subsc{\Maj7}}\zw{'a}\zw{''c}\zw{''e}\wh{''g}\en%
  \Notes%
  \zchordsu{B\aFlat\subsc7}\zw{'b}\zw{''d}\zw{''f}\wh{''a}\en%
  \alaligne%
  \makeatletter\hardspace{-\sign@skip}\makeatother
  \makeatletter\hardspace{.8\Internote}\makeatother
  \znotes\zchordsuu{和声的短音階}\en%
  \Notes%
  \zchordsu{C\Min\subsc{\Maj7}}\zw{'c}\zw{'e}\zw{'g}\wh{='b}\en%
  \Notes%
  \zchordsu{D\hDim\subsc7}\zw{'d}\zw{'f}\zw{'a}\wh{''c}\en%
  \Notes%
  \zchordsu{E\aFlat\Aug\subsc{\Maj7}}\zw{'e}\zw{'g}\zw{='b}\wh{''d}\en%
  \Notes%
  \zchordsu{F\Min\subsc7}\zw{'f}\zw{'a}\zw{''c}\wh{''e}\en%
  \Notes%
  \zchordsu{G\subsc7}\zw{'g}\zw{='b}\zw{''d}\wh{''f}\en%
  ...
  \zchordsu{A\aFlat\subsc{\Maj7}}\zw{'a}\zw{''c}\zw{''e}\wh{''g}\en%
  \Notes%
  \zchordsu{B\Dim\subsc7}\zw{='b}\zw{''d}\zw{''f}\wh{''a}\en%
  \alaligne%
  \makeatletter\hardspace{-\sign@skip}\makeatother
  \makeatletter\hardspace{.8\Internote}\makeatother
  ...
  \zchordsu{E\aFlat\Aug\subsc{\Maj7}}\zw{'e}\zw{'g}\zw{='b}\wh{''d}\en%
  \Notes%
  \zchordsu{F\subsc7}\zw{'f}\zw{='a}\zw{''c}\wh{''e}\en%
  \Notes%
  \zchordsu{G\subsc7}\zw{'g}\zw{='b}\zw{''d}\wh{''f}\en%
  \Notes%
  \zchordsu{A\hDim\subsc7}\zw{='a}\zw{''c}\zw{''e}\wh{''g}\en%
  \Notes%
  \zchordsu{B\hDim\subsc7}\zw{='b}\zw{''d}\zw{''f}\wh{=''a}\en%
  \endpiece%
  \piececaption{各音階上の7thコード}%
  \piecelabel{各音階上の7thコード}%
\end{Music}
調性内三和音の7thコード（\pieceref{各音階上の7thコード}）は
三和音の構成音と第七音の音高によって\tblref{7thコードの種類}のように分けられます．
...
\section{属七の和音，ドミナント7thコード}\sectlabel{属七の和音}
...
この和音は\Gnvii\Dim が\Gnv\subsc7の根音省略と見なされるように，
\Gnv\subsc{9}（\chapref{tension}）の根音省略と見なされて
\Gni(\Min)へと進行することがあります（\pieceref{導七の和音}）．
...
\Gnv\lhsc{7}{\Minus9}の根音省略と見なすのも同様です（\pieceref{減七の和音}）．
...
（\pieceref{ドミナントとサブドミナントの混合としての導音上の七の和音}）．

\begin{Music}[0.6\linewidth]
  \nostartrule%
  \Startpiece%
  \NOtes%
  \zchordsu{G\subsc7}\zw{'f}\zw{'d}\zw{b}\lpar{g}\rpar{g}\wh{g}%
  \zchordsu{B\hDim\subsc7}\zw{'a}\zw{'f}\zw{'d}\wh{b}%
  \zchordsu{F\subsc6}\lpar{''c}\rpar{''c}\zw{''c}\zw{'a}\zw{'f}\wh{'d}%
  \en\generalsignature{-3}\changecontext%
  \NOtes%
  \zchordsu{G\subsc7}\zw{'f}\zw{'d}\zw{=b}\lpar{g}\rpar{g}\wh{g}%
  \zchordsu{B\Dim\subsc7}\zw{'a}\zw{'f}\zw{'d}\wh{=b}%
  \zchordsu{F\Min\subsc6}\lpar{''c}\rpar{''c}\zw{''c}\zw{'a}\zw{'f}\wh{'d}%
  \en%
  \endpiece%
  \piececaption{導音上の七の和音はドミナントとサブドミナントの混合としても看做される．}%
  \piecelabel{ドミナントとサブドミナントの混合としての導音上の七の和音}%
\end{Music}

このような認識はまた\pieceref{正格終止とプラガル終止の複合}のような進行を
正格終止とプラガル終止の複合であるとみなすことも可能にします．
...
\begin{Music}[0.6\linewidth]
  ...
  \en\setdoublebar%
  \endpiece%
  \piececaption{正格終止とプラガル終止の複合としても看做される例．}%
  \piecelabel{正格終止とプラガル終止の複合}%
\end{Music}
...
\pieceref{七の和音の第七音と根音の衝突の例}(b)ではピアノの最高音であるBがメロディのCと短2度音程を構成し，
鋭い不協和となります．
(c)はBの音を内声に持ってきているため多少は不協和が誤魔化されますが，避けるのが基本的には良いとされます．
他方，(d)のように第七音と根音が長2度音程である場合は幾分か不協和の度合いが穏やかになります．
...
\begin{Music}
  ...
  \en\setdoublebar%
  \endpiece%
  \piececaption{七の和音の第七音と根音の衝突の例．}%
  \piecelabel{七の和音の第七音と根音の衝突の例}%
\end{Music}
\begin{comment}
...
\begin{floatMusic}[pos=ht]
  ...
  \znotes\zchordsuu{自然的長音階}\en
  \Notes%
  \zchordsu{C\subsc{6}}\rw{'a}\zw{'g}\zw{'e}\wh{'c}\en%
  \Notes%
  \zchordsu{D\Min\subsc{6}}\rw{'b}\zw{'a}\zw{'f}\wh{'d}\en%
  \Notes%
  \sk%\zchordsuu{Em\subsc{6}}\zw{'e}\zw{'g}\zw{'b}\wh{''d}
  \en%
  \Notes%
  \zchordsu{F\subsc{6}}\rw{''d}\zw{''c}\zw{'a}\wh{'f}\en%
  \Notes%
  \zchordsu{G\subsc{6}}\rw{''e}\zw{''d}\zw{'b}\wh{'g}\en%
  \Notes%
  \sk%\zchordsuu{Am\subsc{6}}\zw{'a}\zw{''c}\zw{''e}\wh{''g}
  \en%
  \Notes%
  \sk%\zchordsuu{B\hDim\subsc7}\zw{'b}\zw{''d}\zw{''f}\wh{''a}
  \en%
  \alaligne%
  \znotes\zchordsuu{和声的長音階}\en%
  \Notes%
  \sk%\zchordsuu{C\subsc{\Maj7}}\zw{'c}\zw{'e}\zw{'g}\wh{'b}
  \en%
  \Notes%
  \zchordsu{D\hDim\subsc{6}}\rw{'b}\zw{_'a}\zw{'f}\wh{'d}\en%
  \Notes%
  \sk%\zchordsuu{Em\subsc7}\zw{'e}\zw{'g}\zw{'b}\wh{''d}
  \en%
  \Notes%
  \zchordsu{F\Min\subsc{6}}\rw{''d}\zw{''c}\zw{_'a}\wh{'f}\en%
  \Notes%
  \zchordsu{G\subsc{6}}\rw{''e}\zw{''d}\zw{'b}\wh{'g}\en%
  \Notes%
  \sk%\zchordsuu{A\aFlat\Aug\subsc{6}}\zw{'a}\zw{''c}\zw{''e}\wh{''g}%
  \en
  \Notes%
  \sk%\zchordsuu{B\hDim\subsc7}\zw{'b}\zw{''d}\zw{''f}\wh{''a}
  \en%
  ...
  \en%
  \Notes%
  \sk%\zchordsuu{Dm\subsc7}\zw{'d}\zw{'f}\zw{'a}\wh{''c}
  \en%
  \Notes%
  \sk%\zchordsuu{Em\subsc7}\zw{'e}\zw{'g}\zw{'b}\wh{''d}
  \en%
  ...
  \zchordsu{F\Min\subsc{6}}\rw{''d}\zw{''c}\zw{_'a}\wh{'f}\en%
  \Notes%
  \zchordsu{G\Min\subsc{6}}\rw{''e}\zw{_''d}\zw{'b}\wh{'g}\en%
  \Notes%
  \sk\en%
  \Notes%
  \zchordsu{B\aFlat\subsc{6}}\rw{''g}\zw{''f}\zw{''d}\wh{_'b}\en%
  \endpiece%
  \nostartrule\generalsignature{-3}%
  \Startpiece%
  \makeatletter\hardspace{-\sign@skip}\makeatother
  ...
  \znotes\zchordsuu{自然的短音階}\en%
  \Notes%
  \sk%\zchordsuu{Cm\subsc7}\zw{'c}\zw{'e}\zw{'g}\wh{'b}
  \en%
  \Notes%
  \sk%\zchordsuu{D\hDim\subsc7}\zw{'d}\zw{'f}\zw{'a}\wh{''c}
  \en%
  \Notes%
  \zchordsu{E\aFlat\subsc{6}}\rw{''c}\zw{'b}\zw{'g}\wh{'e}\en%
  \Notes%
  \zchordsu{F\Min\subsc{6}}\rw{''d}\zw{''c}\zw{'a}\wh{'f}\en%
  \Notes%
  \sk%\zchordsuu{Gm\subsc7}\zw{'g}\zw{'b}\zw{''d}\wh{''f}
  \en%
  \Notes%
  \zchordsu{A\aFlat\subsc{6}}\rw{''f}\zw{''e}\zw{''c}\wh{'a}\en%
  \Notes%
  \zchordsu{B\aFlat\subsc{6}}\rw{''g}\zw{''f}\zw{''d}\wh{'b}\en%
  \alaligne%
  \makeatletter\hardspace{-\sign@skip}\makeatother
  \makeatletter\hardspace{.8\Internote}\makeatother
  \znotes\zchordsuu{和声的短音階}\en%
  \Notes%
  \sk%\zchordsuu{Cm\subsc{\Maj7}}\zw{'c}\zw{'e}\zw{'g}\wh{='b}
  \en%
  \Notes%
  \zchordsu{D\hDim\subsc{6}}\na{'b}\rw{'b}\zw{'a}\zw{'f}\wh{'d}\en%
  \Notes%
  \sk%\zchordsuu{E\aFlat\Aug\subsc{6}}\zw{'e}\zw{'g}\zw{='b}\wh{''d}%
  \en%
  \Notes%
  \zchordsu{F\Min\subsc{6}}\rw{''d}\zw{''c}\zw{'a}\wh{'f}\en%
  \Notes%
  \sk%\zchordsuu{G\subsc7}\zw{'g}\zw{='b}\zw{''d}\wh{''f}
  \en%
  \Notes%
  \zchordsu{A\aFlat\subsc{6}}\rw{''f}\zw{''e}\zw{''c}\wh{'a}\en%
  \Notes%
  \sk%\zchordsuu{B\Dim\subsc7}\zw{='b}\zw{''d}\zw{''f}\wh{''a}
  \en%
  \alaligne%
  \makeatletter\hardspace{-\sign@skip}\makeatother
  \makeatletter\hardspace{.8\Internote}\makeatother
  \znotes\zchordsuu{旋律的短音階}\en%
  \Notes%
  \zchordsu{C\Min\subsc{6}}\na{'a}\rw{'a}\zw{'g}\zw{'e}\wh{'c}\en%
  \Notes%
  \zchordsu{D\Min\subsc{6}}\na{'b}\na[l]{'a}\rw{'b}\zw{'a}\zw{'f}\wh{'d}\en%
  \Notes%
  \sk%\zchordsuu{E\aFlat\Aug\subsc{6}}\zw{'e}\zw{'g}\zw{='b}\wh{''d}%
  \en%
  \Notes%
  ...
  \en%
  \Notes%
  \sk%\zchordsuu{A\hDim\subsc7}\zw{='a}\zw{''c}\zw{''e}\wh{''g}
  \en%
  \Notes%
  \sk%\zchordsuu{B\hDim\subsc7}\zw{='b}\zw{''d}\zw{''f}\wh{=''a}
  \en%
  \endpiece%
  \piececaption{各音階上の6thコード}%
  \piecelabel{各音階上の6thコード}%
\end{floatMusic}

6thコードは7thコードとは違い3度堆積の和音ではなくなっているため，特に「付加」六度の和音と呼びます
（\pieceref{各音階上の6thコード}）．
この種の和音は特に下属音上に構成されることが多い他，
主音や上属音上において解決を要さない用法で用いられることがあります．
...
\begin{floatMusic}[pos=ht,width=0.5\linewidth]
  ...
  \Startpiece%
  \NOTes%
  \zchordsu{C}\itied{0}{''c}\zh{''e}\zh{''c}\zh{'g}\hl{'c}%
  \en%
  \NOTes%
  \zchordsu{F\subsc{6}}\zchordsll{\Funktion{S\hochgestellt{\subsupsc56}}}%
    \MlineB{6}{1}\loff{\ttie{0}}\zh{''d}\lh{''c}\zh{'a}\hl{'f}%
  \en\bar%
  \NOTEs%
  \zchordsu{C}\zw{''e}\zw{''c}\zw{'g}\wh{'c}%
  \en%
  \generalsignature{-3}\setdoublebar\changecontext%
  \NOTes%
  \zchordsu{C\Min}\itied{0}{''c}\zh{''e}\zh{''c}\zh{'g}\hl{'c}%
  \en%
  \NOTes%
  ...
  \en\bar%
  \NOTEs%
  \zchordsu{C\Min}\zw{''e}\zw{''c}\zw{'g}\wh{'c}%
  \en\setdoublebar%
  \endpiece
  \piececaption{6thコードの連結}%
  \piecelabel{6thコードの連結}%
\end{floatMusic}

% 2025-11-23
ジャズなどの比較的複雑な響きの和音を常用するジャンルでは
主和音として\Gni(\Min)\subsc6を使うことがあります（\pieceref{主和音としての6thコード}）．
これは6thコードの響きを求めてという理由以外にも，
特に旋律に主音が来るときに7thコードを使用すると2度の衝突を生じるのでこれを避けるためというのがあります．

\begin{floatMusic}[pos=ht]
  \instrumentnumber{2}%
  \def\Piano{1}\def\Guitar{2}%
  \generalmeter{\meterC}%
  \setstaffs{1}{2}%
  \setclef{1}{\bass}%
  \Startpiece%
  \znotes&\zchordsu{D\Min\subsc9}\en
  \Notest%
  \wh{d}%
  |\zw{''c}\zw{'a}\rw{'f}\wh{'e}%
  &\ibl0{''e}{0}\qb0{''e}\bltext0\qb0{''f}\tql0{''e}%
  \en\Notes
  &\Ibl0{''d}{''c}1\qb0{''d}\tql0{''c}%
  \Ibu0{'b}{'a}1\qb0{'b}\tqu0{'a}%
  \Ibu0{'g}{'g}1\qb0{'g}\fl{'g}\tqu0{'g}%
  \en\bar
  \znotes&\zchordsu{G\subsc9}\en
  \Notes%
  \wh{g}%
  |\rw{'b}\zw{'a}\zw{'f}\wh{'d}%
  &\Ibu0{'f}{'a}1\qb0{'f}\tqu0{'a}%
  \Dqbl{''c}{''e}%
  \Dqbl{''f}{''e}%
  \Dqbl{''d}{'b}%
  \en\bar
  \znotes&\zchordsu{C\subsc6}\en
  \NOTEs%
  \wh{c}%
  |\zw{''c}\rw{'a}\zw{'g}\wh{'e}%
  &\wh{''c}%
  ...
  \generalsignature{-3}%
  \Startpiece%
  \znotes&\zchordsu{D\hDim\subsc9}\en
  \Notest%
  \wh{d}%
  |\zw{''c}\zw{'a}\rw{'f}\na{'e}\wh{'e}%
  &\ibl0{''e}{0}\na{''e}\qb0{''e}\bltext0\qb0{''f}\tql0{''e}%
  \en\Notes
  &\Ibl0{''d}{''c}1\qb0{''d}\tql0{''c}%
  \Ibu0{'b}{'a}1\qb0{'b}\tqu0{'a}%
  \Ibu0{'g}{'g}1\qb0{'g}\fl{'g}\tqu0{'g}%
  \en\bar
  \znotes&\zchordsu{G\subsupsc7{\Minus9}}\en
  \Notes%
  \wh{g}%
  |\na{'b}\rw{'b}\zw{'a}\zw{'f}\wh{'d}%
  &\Ibu0{'f}{'e}1\qb0{'f}\tqu0{'e}%
  \Dqbu{'d}{'a}%
  \Dqbu{'g}{'f}%
  \Ibu0{'d}{b}1\qb0{'d}\na{b}\tqu0{b}%
  \en\bar
  \znotes&\zchordsu{C\Min\subsc6}\en
  \NOTEs%
  \wh{c}%
  |\zw{''c}\na{'a}\rw{'a}\zw{'g}\wh{'e}%
  &\wh{'c}%
  \en\setdoublebar\endpiece
  \piececaption{主和音としての6thコード}%
  \piecelabel{主和音としての6thコード}%
\end{floatMusic}
...
\begin{floatMusic}[pos=ht,width=0.5\linewidth]
  ...
  \Startpiece%
  \Notes%
  \zchordsu{F\subsc{6}}\rw{''d}\zw{''c}\zw{'a}\wh{'f}%
  \en\bar%
  \Notes%
  \zchordsu{D\Min\subsc7}\zw{''c}\zw{'a}\zw{'f}\wh{'d}%
  \en%
  \generalsignature{-3}\setdoublebar\changecontext%
  \Notes%
  \zchordsu{F\Min\subsc{6}}\rw{''d}\zw{''c}\zw{'a}\wh{'f}%
  \en\bar%
  \Notes%
  \zchordsu{D\hDim\subsc7}\zw{''c}\zw{'a}\zw{'f}\wh{'d}%
  \en\setdoublebar%
  \endpiece
  \piececaption{6thコードの転義}%
  \piecelabel{6thコードの転義}%
\end{floatMusic}
...
\Funktion{S}---\Funktion{D}---\Funktion{T}という原型をもちます（\pieceref{正格終止}）．
...
一種敬虔な，柔らかい印象を与えます（\pieceref{プラガル（変格）終止}）．
...
\begin{Music}[.6\linewidth]
  ...
  \en\setdoublebar
  \endpiece
  \piececaption{プラガル（変格）終止}%
  \piecelabel{プラガル（変格）終止}%
\end{Music}
...
主音への下行導音として働きます．
またこれの変形として，\bFlat\Gnii---\Gni という進行も考えることができます（\pieceref{フリギア終止}）．
...
その変化音による半音進行が\pieceref{対斜が生じる例}のように
複数声部にまたがっていることを\KeyBF{対斜}あるいは\KeyBF{錯誤対立}といいます．
\pieceref{対斜が生じない例}(a)のように，
音階固有音と変化音が同一声部に保たれて順次進行している場合には対斜は成立しません．
また\pieceref{対斜が生じない例}(b)のように，
半音変化を受けていない方の音（音階固有音）が重複されている場合は，どちらか一方が順次進行していれば対斜は成立しません．
...
この二種類の導音機能を自然的長音階および自然的短音階に用いると
\pieceref{自然的導音および技巧的導音}のようになります．
...
\begin{floatMusic}[width=0.9\linewidth]
  ...
  \tslur{1}{'a}\wh{'a}%
  \islurd{1}{'a}\nq{^'a}%
  \tslur{1}{'b}\Jovbkt{''c}{1}{1}\cchordsu{自然的上行導音}\wh{'b}%
  \wh{''c}%
  \en\setdoublebar\bar%
  \Notes%
  \wh{''c}%
  ...
  \tslur{1}{'b}\wh{'b}%
  \islurd{1}{'b}\dfl{'b}\nq{'b}%
  \tslur{1}{'a}\Jovbkt{'b}{1}{-1}\cchordsu{自然的下行導音}\wh{'a}%
  \wh{'g}%
  \islurd{1}{'g}\nq{_'g}%
  \tslur{1}{'f}\wh{'f}%
  \islurd{1}{'f}\nq{_'f}%
  ...
  \tslur{1}{'c}\wh{'c}%
  \en\setdoublebar\endpiece%
  \piececaption{自然的導音および技巧的導音．}%
  \piecelabel{自然的導音および技巧的導音}%
\end{floatMusic}
...
\pieceref{C Major上でCを上行変化させたときに新たに作られる和音}は
C Major上でCを上行変化させたときに新たに作られる和音を示しています．
\begin{floatMusic}[width=0.6\linewidth]
  \nostartrule%
  \generalsignature{0}%
  \Startpiece
  \Notes%
  \zchordsu{C\aSharp\Dimt}\zw{''g}\zw{''e}\wh{^''c}%
  \zchordsu{A}\zw{''e}\zw{^''c}\wh{'a}%
  \zchordsu{F\Aug}\zw{^''c}\zw{'a}\wh{'f}%
  \en\bar%
  \Notes%
  \zchordsu{C\aSharp\hDim\subsc7}\zw{''b}\zw{''g}\zw{''e}\wh{^''c}%
  \zchordsu{A\subsc7}\zw{''g}\zw{''e}\zw{^''c}\wh{'a}%
  \zchordsu{F\Aug\subsc{\Maj7}}\zw{''e}\zw{^''c}\zw{'a}\wh{'f}%
  \zchordsu{D\Min\subsc{\Maj7}}\zw{^''c}\zw{'a}\zw{'f}\wh{'d}%
  \en%
  \endpiece
  \piececaption{C Major上でCを上行変化させたときに新たに作られる和音．}%
  \piecelabel{C Major上でCを上行変化させたときに新たに作られる和音}%
\end{floatMusic}
...
そのためこの和音は相対的変化和音であるといえます（\pieceref{相対的変化和音(a)と絶対的変化和音(b)}(a)）．

絶対的変化和音は相対的変化和音と異なり，どの調であっても調性内和音とはなりえない和音のことを指します．
例えばD\supsc{\Minus5}（D\Min\supsc{\Minus5}$=$D\Dimt のことではない）という和音は
どの調でも調性内和音とはなりえません．
そのためこの和音は絶対的変化和音であるといえます（\pieceref{相対的変化和音(a)と絶対的変化和音(b)}(b)）．
\begin{floatMusic}[width=0.6\linewidth]
  \nostartrule%
  \generalsignature{0}%
  \Startpiece
  \znotes\lcharsu{}\en
  \Notes%
  \lchordsl{C:}\zchordsl{\Gnii}\zchordsu{D}\zw{'a}\zw{^'f}\wh{'d}%
  \en\generalsignature{2}\changecontext%
  \Notes%
  \lchordsl{D:}\zchordsl{\Gni}\zchordsu{D}\zw{'a}\zw{'f}\wh{'d}%
  \en\setdoublebar\generalsignature{0}\ignorenats\changecontext%
  \Notes%
  \zchordsu{D\supsc{\Minus5}}\zw{_'a}\sh[l]{'f}\zw{'f}\wh{'d}%
  \en%
  \endpiece
  \piececaption{相対的変化和音(a)と絶対的変化和音(b)．}%
  \piecelabel{相対的変化和音(a)と絶対的変化和音(b)}%
\end{floatMusic}
...
\begin{floatMusic}[width=0.9\linewidth]
  ...
  \en\doublebar
  \Notes
  \zchordsuu{C}\Ibu0{'d}{'f}3\zcharsu{*}\qb0{'d}%
  \qb0{'c}%
  \zcharsu{*}\qb0{'f}%
  \tqu0{'e}%
  \en\bar\NOTesp%
  ...
  \en\setdoublebar
  \endpiece%
  \piececaption{Scalewise Approach Note}%
\end{floatMusic}
...
\begin{floatMusic}[width=0.9\linewidth]
  ...
  \Startpiece%
  \Notes
  \zchordsuu{G\subsc7}\Ibu0{'g}{'e}3\qb0{'g}%
  \zcharsu{*}\qb0{_'g}%
  \qb0{'f}%
  \tqu0{'d}%
  \en\bar\Notes%
  \zchordsuu{C}\zcharsu{*}\Ibu0{'d}{'e}1\qb0{^'d}%
  \tqu0{'e}%
  \en\NOtes
  \qp
  \en\doublebar
  \Notes
  \zchordsuu{C}\Ibu0{'d}{'f}3\zcharsu{*}\qb0{_'d}%
  \qb0{'c}%
  \zcharsu{*}\zcharsl{注}\qb0{'f}%
  \tqu0{'e}%
  \en\bar\NOTesp%
  \zcharsu{*}\qap{_'a}%
  \en\Notes
  ...
  \en\setdoublebar
  \endpiece%
  \piececaption{Chromatic Approach Note}%
\end{floatMusic}
\begin{chuui}
...
\begin{floatMusic}[width=0.9\linewidth]
  ...
  \en\doublebar
  \Notes
  \zchordsuu{C}\Ibu0{'d}{'e}3\zcharsu{*}\qb0{'d}%
  \zcharsu{*}\qb0{_'d}%
  \qb0{'c}%
  \tqu0{'e}%
  \en\bar\Notes%
  \zcharsu{*}\ibu0{'a}0\qb0{'a}%
  \zcharsu{*}\tqu0{_'a}%
  \en\NOtes
  \qa{'g}%
  \en\doublebar
  ...
  \en\setdoublebar
  \endpiece%
  \piececaption{Double Chromatic Approach Note}%
\end{floatMusic}
...
\begin{floatMusic}[width=0.9\linewidth]
  ...
  \tqu0{'g}%
  \en\bar\Notes%
  \Ibu0{'f}{'d}1\zcharsu{*}\qb0{'f}%
  \zcharsu{*}\tqu0{'d}%
  \en\NOtes
  \qa{'e}%
  \en\setdoublebar
  \endpiece%
  \piececaption{Double Approach Note}%
\end{floatMusic}
...
\begin{floatMusic}[width=0.9\linewidth]
  ...
  \en\doublebar%
  \NOTes\zchordsuu{G}%
    \zchordsu{3}\itieu0{'b}\ha{'b}%
  \en\bar\NOtes\zchordsuu{C}%
    \zchordsu{\dPos1}\ttie0\qa{'b}%
    \zchordsu{1}\qa{''c}%
  \en\setdoublebar%
  \endpiece%
\end{floatMusic}
\begin{floatMusic}[width=0.9\linewidth]
  ...
  \NOtes\zchordsuu{C}%
    \zchordsu{5}\qa{'g}%
    \zchordsu{\uPos5}\qa{'a}%
    \zcharsl{*}\zchordsu{\dPos1}\qa{'b}%
    \zchordsu{1}\qa{''c}%
  \en\doublebar%
  \NOtes\zchordsuu{C}%
    \zchordsu{1}\qa{''c}%
    \zchordsu{\dPos1}\qa{'b}%
    \zcharsl{*}\zchordsu{\uPos5}\qa{'a}%
    \zchordsu{5}\qa{'g}%
  \en\doublebar%
  \NOtes\zchordsuu{C}%
    \zchordsu{5}\qa{'g}%
...
\begin{floatMusic}[width=0.9\linewidth]
  ...
  \en\NOtes\zchordsuu{G}%
    ...
    \zchordsu{\uPos3}\qa{''c}%
  \en\bar%
  \NOtes\zchordsuu{A\Min}%
    \zchordsu{1}\qa{'a}%
    \zchordsu{\uPos1}\qa{'b}%
  \en\NOtes\zchordsuu{E\Min}%
    \zchordsu{3}\qa{'g}%
    \zchordsu{\uPos3}\qa{'a}%
  \en\bar%
  \NOTes\zchordsuu{F}%
...
\begin{itemize}
  \item \KeyBF{刺繍音}：前部原位を持つ・後部復元転位音
  \item \KeyBF{経過音}：前部原位を持つ・後部経過転位音
  \item \KeyBF{倚音}：和音交代点・内部変換点で出現する前部復元転位音
  \begin{itemize}
    \item \KeyBF{後部倚音}：前部原位を持たない・後部復元転位音
    \item \KeyBF{刺繍的倚音}：先行音が原位である倚音
    \item \KeyBF{経過的倚音}：先行音が原位と逆方向の隣接音である倚音
  \end{itemize}
  \item \KeyBF{掛留音}：和音交代点・前の和声音と同じ音で結合された（タイで結ばれた）転位音
  \item \KeyBF{先取音}：保留転位音
  \item \KeyBF{逸音}：過復元転位音
\end{itemize}

\section{古典的な和声法での取り扱い方}
古典的な和声法~\cite{chSHIMOFUSA1,chSHIMOFUSA2,mgKIKUCHI1}では非和声音を次のように分類します．
\begin{itemize}
  \item \KeyBF{補助音}：弱拍上の順次解決する非和声音
  \item \KeyBF{経過音}：弱拍上の経過解決する非和声音
  \item \KeyBF{倚音}：  強拍上の順次解決する非和声音
  \item \KeyBF{掛留音}：先行和音から残された非和声音
  \item \KeyBF{先取音}：後続和音から先取した非和声音
  \item \KeyBF{逸音}：  弱拍上の順次進行で入り跳躍復元解決する非和声音
\end{itemize}
...
\end{itemize}
として考えられます（\pieceref{ある和音を共通和音とする近親調または遠隔調．}）．

\begin{floatMusic}[pos=ht,width=0.6\linewidth]
  \nostartrule%
  \generalsignature{0}%
  \Startpiece
  ...
  \en\setdoublebar%
  \endpiece
  \piececaption{ある和音を共通和音とする近親調または遠隔調．}%
  \piecelabel{ある和音を共通和音とする近親調または遠隔調．}%
\end{floatMusic}
...
その逆，またはどちらの調においてもノンダイアトニック・コードである
ということも可能です（\pieceref{半音変化を伴う和音を共通和音とする転調．}）．
\begin{floatMusic}[pos=ht]
  \generalmeter{\meterC}%
  \generalsignature{0}%
  \setstaffs{1}{2}\setclef{1}{6}%
  ...
  \ha{e}%
  |\zchordsu{G}\zh{'b}\zh{'g}\hu{'d}%
  \zchordsu{C/E}\zh{''c}\zh{'g}\hu{'c}%
  \en\bar%
  \NOTes%
  \zchordsl{\Gnii\Min}\ha{d}%
  \lrchordsl{es:&\Gniv\Min\subsc6}\ha{_a}%
  |\zchordsu{D\Min}\zh{''d}\zh{'a}\hu{'f}%
  \zchordsu{A\aFlat\Min\subsc6}\zh{_''e}\fl[hql]{''c}\zh{''c}\hl{'f}%
  \en\bar\addspace{.3\afterruleskip}%
  \NOTes%
  \ha{_b}%
  \ha{_B}%
  |\zchordsu{\hspace{-\QNwidth}E\aFlat\Min/B\aFlat}\zh{_''e}\fl[hql]{'b}\zh{'b}\hl{_'g}%
  \zchordsu{B\aFlat}\zh{''d}\zh{'b}\hu{'f}%
  \en\bar\addspace{.3\afterruleskip}%
  \NOTEs%
  \wh{_e}%
  |\zchordsu{E\aFlat\Min}\zw{_''e}\fl[hql]{'b}\zw{'b}\wh{_'g}%
  \en\setdoublebar%
  \endpiece
  \piececaption{半音変化を伴う和音を共通和音とする転調．}%
  \piecelabel{半音変化を伴う和音を共通和音とする転調．}%
\end{floatMusic}
...
（\pieceref{全ての構成音にエンハーモニック転換を行う例．}）．

\begin{floatMusic}[pos=ht,width=.6\linewidth]
  \nostartrule%
  \generalsignature{-5}%
  \Startpiece
  \Notes%
  \lrchordsl{Des:&\Gnvii\Dimt}\zchordsu{C\Dimt}%
    \zw{'g}\zw{'e}\wh{'c}%
  \en\setdoublebar\generalsignature{+4}\ignorenats\changecontext%
  \Notes%
  \lrchordsl{cis:\hspace{\QNwidth}&\Gnvii\Dimt}\zchordsu{B\aSharp\Dimt}%
    \zw{'f}\zw{'d}\wh{^b}%
  \en\setdoublebar
  \endpiece
  \piececaption{全ての構成音にエンハーモニック転換を行う例．}%
  \piecelabel{全ての構成音にエンハーモニック転換を行う例．}%
\end{floatMusic}
...
（\pieceref{一部の構成音にエンハーモニック転換を行う例．}）．
...
\begin{floatMusic}[pos=ht,width=.7\linewidth]
  \nostartrule%
  \Startpiece
  \Notes%
  \zchordsu{G\aSharp\Dim\subsc7}%
    \zw{'f}\zw{'d}\zw{b}\wh{^g}%
  \en%
  \Notes\zchordsu{$=$}\en%
  \Notes%
  \zchordsu{B\Dim\subsc7}%
    \zw{_'a}\zw{'f}\zw{'d}\wh{b}%
  \en%
  \Notes\zchordsu{$=$}\en%
  \Notes%
  \zchordsu{D\Dim\subsc7}%
    \zw{_''c}\fl[l]{'a}\zw{'a}\zw{'f}\wh{'d}%
  \en%
  \Notes\zchordsu{$=$}\en%
  \Notes%
  \zchordsu{F\Dim\subsc7}%
    \zw{_''e}\fl[qll]{''c}\zw{''c}\fl[ql]{'a}\zw{'a}\wh{'f}%
  \en%
  \Notes\zchordsu{$=$}\en%
  \Notes%
  \zchordsu{A\aFlat\Dim\subsc7$=$G\aSharp\Dim\subsc7}%
    \zw{<''g}\fl[ll]{''e}\zw{''e}\fl[ql]{''c}\zw{''c}\fl[qll]{''c}\wh{'a}%
  \en%
  \endpiece
  \Startpiece
  \Notes%
  \zchordsu{A\aFlat\Aug}%
    \zw{'e}\zw{'c}\wh{_a}%
  \en%
  \Notes\zchordsu{$=$}\en%
  \Notes%
  ...
  \Notes%
  \zchordsu{E\Aug}%
    \zw{^'b}\sh[l]{'g}\zw{'g}\wh{'e}%
  \en%
  \Notes\zchordsu{$=$}\en%
  \Notes%
  \zchordsu{G\aSharp\Aug$=$A\aFlat\Aug}%
    \zw{>'d}\sh[hll]{'b}\zw{'b}\sh[hl]{'g}\wh{'g}%
  \en%
  \endpiece
  \generalsignature{0}%
  \Startpiece
  \Notes%
  \zchordsu{B\lhsc{7}{\bFlat5}}%
    \zw{'a}\zw{'f}\zw{^'d}\wh{b}%
  \en%
  \Notes\zchordsu{$=$}\en%
  \Notes%
  \zchordsu{F\lhsc{7}{\bFlat5}}%
    \zw{_''e}\fl[l]{''c}\zw{''c}\zw{'a}\wh{'f}%
  \en%
  \Notes\zchordsu{$=$}\en%
  \Notes%
  \zchordsu{C\aFlat\lhsc{7}{\bFlat5}$=$B\lhsc{7}{\bFlat5}}%
    \dfl{''b}\dfl[hll]{''g}\fl[ql]{''e}\fl[l]{''c}\zw{''b}\zw{''g}\zw{''e}\wh{''c}%
  \en%
  \endpiece\vspace{-.5\baselineskip}%
  \piececaption{一部の構成音にエンハーモニック転換を行う例．}%
  \piecelabel{一部の構成音にエンハーモニック転換を行う例．}%
\end{floatMusic}
...
\begin{floatMusic}[pos=ht]
  ...
  \figbassuuu[3][\txSharp4][6]%
    \lrchordsl{A:&\Funktion{\Stellung{\Slash D}{7}\Hochgestellt{9\tiefalt}}}%
    \zql{d}\qu{b}%
  \figbassuuu[6]\zchordsl{\Funktion{\Stellung{T}{c}}}%
    \zql{^c}\qu{a}%
  |\zql{'g}\qu{''c}%
  \zql{'e}\qu{'g}%
  \rql{'f}\qu{^'g}%
  ...
  \en\bar
  \NOtes
  \figbassuuu[\txSharp][7]\lrchordsl{H: &\Funktion{D\Hochgestellt{\subsupsc{5\tiefalt}7}}}%
    \zql{^f}\qu{'c}%
  \figbassuuu[\txSharp][6]\cchordsl{\Funktion{\Stellung{T}{3}}}%
    \zql{^d}\qu{b}%
  \figbassuuu[\txFlat5][\txSharp6]%
    \lrchordsl{G:&\Funktion{\Stellung{\Slash{\WechselD}}{5\tiefalt}\Hochgestellt{\subsupsc7{9\tiefalt}}}}%
    \fl[ql]{e}\zql{e}\qu{_b}%
  \figbassuuu[\txSharp]\zchordsl{\Funktion{D}}%
    \zql{=d}\qu{a}%
  |\zql{'e}\qu{^'a}%
  \zql{^'f}\qu{'b}%
  \zql{'g}\qu{^''c}%
  \zql{'f}\qu{''d}%
  \en\bar\addspace{.5\afterruleskip}%
  \NOtes
  \figbassuuu[6]\zchordsl{\Funktion{\Stellung{Tp}{3}}}%
    \zql{g}\parna{b}\qu{b}%
  \figbassuuuu[3][4][\txSharp6]%
    \zql{a}\qu{^'d}%
  \figbassuuuu[6]%
    \zql{g}\qu{'e}%
  \figbassuuuu[\txFlat][5][6]\lrchordsl{C: &\Funktion{s\Hochgestellt{\subsupsc56}}}%
    \zql{f}\qu{='d}%
  |\zql{'g}\qu{''e}%
  \zql{''c}\qu{^''f}%
  \zql{'b}\qu{''g}%
  ...
  \en\bar%
  \NOtes
  \figbassuuuu[4][6]\zchordsl{\Funktion{D\Hochgestellt{\subsupsc46}}}%
    \zhl{g}\hu{'e}%
  \figbassuuuu[---][---]\sk%
  \figbassuuuu[3][5]%
    \zhl{G}\hu{b}%
  ...
  \en\setdoublebar%
  \endpiece
  \piececaption{ドミナント7thを用いた転調．}%
  \piecelabel{ドミナント7thを用いた転調．}%
\end{floatMusic}
%\begin{chuui}
...
\pieceref{ドミナント7thを用いた転調の連鎖．}は最も極端な例と言えるでしょう．
...
\begin{floatMusic}[pos=ht]
  ...
  \en\setdoublebar%
  \endpiece
  \piececaption{ドミナント7thを用いた転調の連鎖．}%
  \piecelabel{ドミナント7thを用いた転調の連鎖．}%
\end{floatMusic}
...
%  \generalsignature{1}%
  ...
  \en\setdoublebar
  \endpiece\vspace{-.5\baselineskip}%
  \piececaption{この種のコード進行はバスによるマイナー・ペンタトニック・スケールの\\%
                メロディを長三和音でハーモナイズしたものとしても考えられる．}%
\end{Music}
